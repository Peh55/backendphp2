...
class Aluno extends CI_Controller{
        ...
        if(verificarParam($resultado, $lista) == 1){
            ...
            */
            ...
            if (trim($this->getRA()) == "" || $this->getRA() == 0){
                ...
                //Realizo a instãncia da Model
                $this->load->model('M_aluno');

                //Atributo $retorno recebe array com informações de validação do acesso
    ...
    public function consultarAluno(){
        ...
        if (verificarParam($resultado, $lista) == 1){
            ...
            /*
                ** VALIDAÇÕES NECESSARIAS RETORNOS POSSÍVEIS **
        ...
        if (verificarParam($resultado, $lista) == 1){
            ...
            */
            ...
            if(strlen($this->getRA()) == 0){
                ...
                //Atributo $retorno recebe array com informações da validação do acesso 
                $retorno = $this->apagarAluno($this->getRA());
            }
        }else{
            $retorno = array('codigo' => 99,
                             'msg' => 'Os campos vindos do FrontEnd não representam o método de consulta,
    ...
    public function reativarAluno(){
        ...
        //Verificação dos parãmetros passados na Helper
        if (verificarParam($resultado, $lista) == 1){
            //Fazendo os setters
            $this->setRA($resultado->ra);
            $this->setIdCurso($resultado->idcurso);
